...
class Transaction extends Model {
    ...
    protected $fillable   = [ 'type', 'form_type', 'status', 'user_id', 'billing_address', 'ref', 'summary', 'issue_date', 'due_date', 'currency', 'conversion_rate', 'total', 'due', 'trans_total', 'files', 'created_by', 'created_at'];
