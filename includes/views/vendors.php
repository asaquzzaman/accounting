<div class="wrap">
    ...
    <h2>Vendors <a href="#" class="add-new-h2">Add New</a></h2>
    ...
    <table class="wp-list-table widefat fixed vendor-list-table">
        <thead>
            <tr>
                ...
                <th class="col-username"><?php _e( 'Vendor', 'accounting' ); ?></th>
            ...
            <tr class="<?php echo $num % 2 == 0 ? 'alternate' : 'odd'; ?>">
                ...
                <td class="username col-username column-username">
                    ...
                    <div class="row-actions">
                        ...
                        <span class="edit"><a href="#" title="Edit this item">Create Bill</a> | </span>
